                ...
                <div class="card">                    
                    ...
                    <div class="card-content">
                        <div class="card-content table-responsive">
                            <a href="<?php echo e(url('/modulos/centrosmedicos/create')); ?>"
                               class="btn btn-success btn-round btn-just-icon"
                               title="Crear Nuevo Centro Médico">
                                <i class="material-icons">add</i></a>

                            <?php echo Form::open(['method' => 'GET', 'url' => '/modulos/centrosmedicos', 'class' => 'navbar-form navbar-right', 'role' => 'search']); ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $centrosmedicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($item->id); ?></td>
                                        <td><?php echo e($item->name); ?></td>
                                        <td><?php echo e($item->address); ?></td>
                                        <td><?php echo e($item->empresa); ?></td>
                                        <td><?php echo e($item->nomarea); ?></td>
                                        <td class="td-actions text-right">
                                            <a href="<?php echo e(url('/modulos/centrosmedicos/' . $item->id)); ?>">
                                                <button type="button" rel="tooltip" title="Ver Datos del Centro Médico"
                                                        class="btn btn-info btn-simple btn-xs">
                                                    <i class="material-icons">remove_red_eye</i>
                                                </button>
                                            </a>
                                            <a href="<?php echo e(url('/modulos/centrosmedicos/' . $item->id . '/edit')); ?>">
                            ...
                            <div class="pagination-wrapper"> <?php echo $centrosmedicos->appends(['search' => Request::get('search')])->render(); ?> </div>
                        </div>
                    </div>
                    <!-- End Body -->
                </div>
