                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            <?php echo Form::text('tipolente', isset($historyFill) ? $historyFill->tipolente : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            <?php echo Form::text('color', isset($historyFill) ? $historyFill->color : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            <?php echo Form::text('filtro', isset($historyFill) ? $historyFill->filtro : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            <?php echo Form::text('coloracion', isset($historyFill) ? $historyFill->coloracion : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            <?php echo Form::text('usolente', isset($historyFill) ? $historyFill->usolente : null,  ['class' => 'form-control','disabled']); ?>
        ...
        <div class="panel panel-default"> <!-- begin: Panel Agudeza Visual (Tab_3) -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                        <select disabled class="form-control" id="od_esfera" name="od_esfera">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                        
                        <select disabled class="form-control" id="od_cilindro" name="od_cilindro">
                                <?php $__currentLoopData = $esfera_cilindro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <select disabled class="form-control" id="od_eje" name="od_eje">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('od_prisma', isset($historyFill) ? $historyFill->od_prisma : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('od_base', isset($historyFill) ? $historyFill->od_base : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">                        
                        <select disabled class="form-control" id="oi_esfera" name="oi_esfera">
                                <?php $__currentLoopData = $esfera_cilindro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="oi_cilindro" name="oi_cilindro">
                                <?php $__currentLoopData = $esfera_cilindro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="oi_eje" name="oi_eje">
                                <?php $__currentLoopData = $eje; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('oi_prisma', isset($historyFill) ? $historyFill->oi_prisma : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('oi_base', isset($historyFill) ? $historyFill->oi_base : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                        <select disabled class="form-control" id="od_av_cerca_cc" name="od_av_cerca_cc">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="od_av_cerca_sc" name="od_av_cerca_sc">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="od_av_lejos_cc" name="od_av_lejos_cc">
                                <?php $__currentLoopData = $cc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="od_av_lejos_sc" name="od_av_lejos_sc">
                                <?php $__currentLoopData = $sc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="od_av_ph" name="od_av_ph">
                                <?php $__currentLoopData = $sc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="oi_av_cerca_cc" name="oi_av_cerca_cc">
                                <?php $__currentLoopData = $cc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                             <select disabled class="form-control" id="oi_av_cerca_sc" name="oi_av_cerca_sc">
                                <?php $__currentLoopData = $sc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="oi_av_lejos_cc" name="oi_av_lejos_cc">
                                <?php $__currentLoopData = $cc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">  
                            <select disabled class="form-control" id="oi_av_lejos_sc" name="oi_av_lejos_sc">
                                <?php $__currentLoopData = $sc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="oi_av_ph" name="oi_av_ph">
                                <?php $__currentLoopData = $sc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <select disabled class="form-control" id="ojo_dominante" name="ojo_dominante">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="ho_forico_cerca_cc" name="ho_forico_cerca_cc">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating"> 
                            <select disabled class="form-control" id="ho_forico_cerca_sc" name="ho_forico_cerca_sc">
                                <?php $__currentLoopData = $ho; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                           
                            <select disabled class="form-control" id="ho_forico_lejos_cc" name="ho_forico_lejos_cc">
                                <?php $__currentLoopData = $ho; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="ho_forico_lejos_sc" name="ho_forico_lejos_sc">
                                <?php $__currentLoopData = $ho; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="ve_forico_cerca_cc" name="ve_forico_cerca_cc">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <select disabled class="form-control" id="ve_forico_cerca_sc" name="ve_forico_cerca_sc">
                                <?php $__currentLoopData = $ve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                            
                            <select disabled class="form-control" id="ve_forico_lejos_cc" name="ve_forico_lejos_cc">
                                <?php $__currentLoopData = $ve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <select disabled class="form-control" id="ve_forico_lejos_sc" name="ve_forico_lejos_sc">
                                <?php $__currentLoopData = $ve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">                          
                            <select disabled class="form-control" id="mano_dominante" name="mano_dominante">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">					
					<div class="form-group label-floating">                           
                            <select disabled class="form-control" id="od_ang_kappa" name="od_ang_kappa">
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                        <?php echo Form::text('ppc_or', isset($historyFill) ? $historyFill->ppc_or : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                    <div class="form-group label-floating">
                            <select disabled class="form-control" id="oi_ang_kappa" name="oi_ang_kappa">
                                <?php $__currentLoopData = $anguloKappa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            <?php echo Form::text('ppc_sf', isset($historyFill) ? $historyFill->ppc_sf : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('od_fijacion', isset($historyFill) ? $historyFill->od_fijacion : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            <?php echo Form::text('ctest_lejos', isset($historyFill) ? $historyFill->ctest_lejos : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('oi_fijacion', isset($historyFill) ? $historyFill->oi_fijacion : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            <?php echo Form::text('ctest_cerca', isset($historyFill) ? $historyFill->ctest_cerca : null,  ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('dist_interpupilar', isset($historyFill) ? $historyFill->dist_interpupilar : null,  ['class' => 'form-control','disabled']); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            <?php echo Form::text('pupila', isset($historyFill) ? $historyFill->pupila : null, ['class' => 'form-control','disabled']); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group label-floating">
                            <?php echo Form::textarea('observacion', isset($historyFill) ? $historyFill->observacion : null, ['class'=>'form-control','disabled', 'rows' => 2, 'cols' => 50, 'maxlength' => '500']); ?>
