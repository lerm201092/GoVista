                ...
                <div class="card">                    
                    ...
                    <div class="card-content">
                        <div class="card-content table-responsive">
                            <a href="<?php echo e(url('/modulos/entidades/create')); ?>"
                               class="btn btn-success btn-round btn-just-icon"
                               title="Crear Nuevo Centro Médico">
                                <i class="material-icons">add</i>
                            </a>
                            <?php echo Form::open(['method' => 'GET', 'url' => '/modulos/entidades', 'class' => 'navbar-form navbar-right', 'role' => 'search']); ?>
                                ...
                                <?php $__currentLoopData = $entidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a href="<?php echo e(url('/modulos/entidades/' . $item->id)); ?>">
                                                <button type="button" rel="tooltip" title="Ver Datos del Médico"
                                                        class="btn btn-info btn-simple btn-xs">
                                                    <i class="material-icons">remove_red_eye</i>
                                                </button>
                                            </a>
                                            <a href="<?php echo e(url('/modulos/entidades/' . $item->id . '/edit')); ?>">
                            ...
                            <div class="pagination-wrapper"> <?php echo $entidades->appends(['search' => Request::get('search')])->render(); ?> </div>
                        </div>
                    </div>
                    <!-- End Body -->
                </div>
