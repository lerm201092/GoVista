                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::open(['url' => '/modulos/empresas', 'class' => 'form', 'files' => true]); ?>


                                    <div class="row">
                                        <div class="col-md-6">
                                            <?php echo Form::hidden('addcoduser', Auth::user()->username, ['class' => 'form-control']); ?>

                                        </div>
                                        <div class="col-md-6">
                                            <?php echo Form::hidden('modcoduser', Auth::user()->username, ['class' => 'form-control']); ?>

                                        </div>
                                    </div>

                                    <?php echo $__env->make('modulos.empresas.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
