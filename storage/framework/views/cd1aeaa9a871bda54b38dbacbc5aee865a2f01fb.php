...
<?php $__env->startSection('content_body'); ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">                    
                    <div class="well well-sm"><span class="titlePage">Creación de Entidades Prestadores de Salud:</span></div>
                    <br>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::open(['url' => '/modulos/entidades', 'class' => 'form', 'files' => true]); ?>
                                    ...
                                    <?php echo $__env->make('modulos.entidades.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
