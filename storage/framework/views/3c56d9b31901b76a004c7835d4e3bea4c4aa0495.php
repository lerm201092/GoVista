                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::model($centrosmedico, [
                                        'method' => 'PATCH',
                                    ...
                                    <?php echo $__env->make('modulos.centrosmedicos.form', ['submitButtonText' => 'Actualizar'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo Form::close(); ?>
