                ...
                <div class="card">                    
                    ...
                    <div class="card-content">
                        <div class="card-content table-responsive">
                            ...
                            <a href="<?php echo e(url('/modulos/medicos/' . $medico[0]->id . '/edit')); ?>"
                               title="Edit Médico">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($medico[0]->id); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Nombre</td>
                                    <td> <?php echo e(ucwords(mb_strtolower($medico[0]->name))); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Especialidad</td>
                                    <td> <?php echo e(ucwords(mb_strtolower($medico[0]->specialty))); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Empresa</td>
                                    <td> <?php echo e(ucwords(mb_strtolower($medico[0]->empresa))); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Departamento</td>
                                    <td> <?php echo e($medico[0]->dpto); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Municipio</td>
                                    <td> <?php echo e($medico[0]->municipio); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Dirección</td>
                                    <td> <?php echo e($medico[0]->address); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> Teléfono</td>
                                    <td> <?php echo e($medico[0]->phone); ?> </td>
                                </tr>
                                <tr>
                                    <td class="text-primary"> E-mail</td>
                                    <td> <?php echo e($medico[0]->email); ?> </td>
                                </tr>
