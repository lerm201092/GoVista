                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::model($medico, [
                                        'method' => 'PATCH',
                                        'url' => ['/modulos/medicos', $medico->id],
                                        'class' => 'form',
                                        'files' => true
                                    ]); ?>
                                    ...
                                    <?php echo $__env->make('modulos.medicos.form', ['submitButtonText' => 'Actualizar'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo Form::close(); ?>
