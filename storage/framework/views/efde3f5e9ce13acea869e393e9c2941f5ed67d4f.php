                            ...
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::model($empresa, [
                                        'method' => 'PATCH',
                                        'url' => ['/modulos/empresas', $empresa->id],
                                        'class' => 'form',
                                        'files' => true
                                    ]); ?>
                                    ...
                                    <?php echo $__env->make('modulos.empresas.form', ['submitButtonText' => 'Actualizar'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo Form::close(); ?>
