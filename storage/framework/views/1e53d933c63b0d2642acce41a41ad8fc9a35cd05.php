                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <?php echo Form::open(['url' => '/modulos/exercises', 'class' => 'form', 'files' => true]); ?>
                                    ...
                                    <?php echo $__env->make('modulos.exercises.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
