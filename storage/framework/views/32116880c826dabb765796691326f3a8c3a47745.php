                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">
                                    ...
                                    <div>
                                        <?php if($errors->any()): ?>
                                            <ul class="alert alert-danger">
                                                <?php if($errors->has('id_patient')): ?>
                                                    <li> Id Paciente :
                                                        <?php echo $errors->first('id_patient', ':message'); ?></li>
                                                <?php endif; ?>
                                                <?php if($errors->has('body')): ?>
                                                    <li> Descripción de la Consulta :
                                                        <?php echo $errors->first('body', ':message'); ?></li>
                                                <?php endif; ?>
                                            </ul>
                                        <?php endif; ?>
                                    </div>

                                    <?php echo Form::open(['url' => '/modulos/appointments', 'class' => 'form', 'files' => true]); ?>
                                    ...
                                    <?php echo $__env->make('modulos.appointments.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
