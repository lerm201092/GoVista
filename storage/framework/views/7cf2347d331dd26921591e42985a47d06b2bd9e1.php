                        ...
                        <div class="row">
                            <div class="col-md-10">							
                                <div class="panel-body">                                   
                                    ...
                                    <?php echo $__env->make('modulos.patients.form', ['submitButtonText' => 'Actualizar','birthdate'=>$patient->birthdate], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
