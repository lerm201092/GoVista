<div class="tab-pane fade" id="tab_6"> <!-- begin: Tab_6 -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">                    
                    <select class="form-control" id="diagnostico1" name="diagnostico1">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">                    
                     <select class="form-control" id="diagnostico2" name="diagnostico2">
                                <?php $__currentLoopData = $rips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    <select class="form-control" id="diagnostico3" name="diagnostico3">
                                <?php $__currentLoopData = $rips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">                    
                    <select class="form-control" id="diagnostico4" name="diagnostico4">
                                <?php $__currentLoopData = $rips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group label-floating">
                    <?php echo Form::text('complicacion', isset($historyFill) ? $historyFill->complicacion : null,  ['class' => 'form-control']); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group label-floating">
                    <?php echo Form::text('finalidad', isset($historyFill) ? $historyFill->finalidad : null,  ['class' => 'form-control']); ?>
