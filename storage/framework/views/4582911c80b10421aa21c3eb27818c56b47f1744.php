...
<label style="line-height: unset !important;" class="containerInput">
  ...
  <input disabled id="id_exercise_<?php echo e($e->id); ?>" name="id_exercise[]" class="form-check-input" type="checkbox" value="<?php echo e($e->id); ?>" checked>  
  <?php else: ?>
  <input disabled id="id_exercise_<?php echo e($e->id); ?>" name="id_exercise[]" class="form-check-input" type="checkbox" value="<?php echo e($e->id); ?>">  
  <?php endif; ?>  
  ...
  <span class="checkmark"></span>
      ...
      <td>	      
	  <div class="form-group label-floating">		    		
	  <input disabled id="useExercise_<?php echo e($e->id); ?>" name="useExercise[]" rel="tooltip" title="<?php echo e($e->useExercise); ?>" class="form-control" readonly type="text" value="<?php echo e($e->useExercise); ?>">
      </div>
	  </td>
      <td>
	  <div class="form-group label-floating">
	...
	<?php endif; ?>
	  ...
	  <div class="form-group label-floating">	  
	  <?php if( count($historyExerciseFill->where('id_exercise', '=', $e->id)) > 0): ?> 
       <input disabled id="session_<?php echo e($e->id); ?>" name="session[]" style="text-align: center !important;width: 80px;" class="form-control" min="1" max="10" type="number" value='<?php echo e($historyExerciseFill->where('id_exercise', '=', $e->id)->first()->session); ?>'>
		<?php else: ?>
		<input disabled id="session_<?php echo e($e->id); ?>" name="session[]" style="text-align: center !important;width: 80px;" class="form-control" min="1" max="10" type="number" value=''>
 	<?php endif; ?> 	
	  </div>
	  </td>
      <td style="width: auto !important;">
	  <div class="form-group label-floating">
<?php if( count($historyExerciseFill->where('id_exercise', '=', $e->id)) > 0): ?> 
		<select disabled class="form-control" id="size_<?php echo e($e->id); ?>" name="size[]">	        
...
<?php endif; ?>		                 
	...
	<?php endif; ?> 
     ...
     <td style="width: auto !important;">
	  <div class="form-group label-floating">	  	
		<?php if( count($historyExerciseFill->where('id_exercise', '=', $e->id)) > 0): ?> 
			<input disabled id="duration_<?php echo e($e->id); ?>" name="duration[]" style="text-align: center !important;width: 80px;" class="form-control" min="5" max="30" step="5" type="number" value='<?php echo e($historyExerciseFill->where('id_exercise', '=', $e->id)->first()->duration); ?>'>
		<?php else: ?>
		<input disabled id="duration_<?php echo e($e->id); ?>" name="duration[]" style="text-align: center !important;width: 80px;" class="form-control" min="5" max="30" step="5" type="number" value=''>
		<?php endif; ?> 			
	  </div>
	  </td>
    </tr>  
