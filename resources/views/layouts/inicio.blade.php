...
<div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div style="margin-top: 15vh !important;" class="brand">
                        <img src="{{ asset('img/GO-VISTA-LOGO-426-113.png') }}" alt="Logo GO Vista">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main main-raised">
        ...
        <div class="section section-tabs"
             style="background-image: url({{ asset('img/bg2.jpg') }}); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                                        ...
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active text-center">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/cerca_de_ti.png') }}" alt="Cerca de Ti">
                                                </a>
                                                <h3>Cerca de Ti</h3>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/rapido_sin_esperas.png') }}"
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/diagnostico_medico.png') }}"
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/economico.png') }}"
        ...
        <div class="section section-tabs"
             style="background-image: url({{ asset('img/bg6.jpg') }}); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <!-- Tabs with icons on Card -->
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/salud_visual.png') }}"
                                                         alt="Salud Visual">
                                                </a>
                                                <h3>Salud visual</h3>
                                            </li>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/ejercicios_personalizados.png') }}"
                                                         alt="Rápido y sin espera">
                                                </a>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/sesiones_personalizadas.png') }}"
                                                         alt="Diagnóstico Integral">
                                                </a>
        ...
        <div class="section section-tabs"
             style="background-image: url({{ asset('img/bg8.jpg') }}); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <!-- Tabs with icons on Card -->
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/personas.png') }}"
                                                         alt="Salud Visual">
                                                </a>
                                                <h3>Personas</h3>
                                            </li>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/informatica.png') }}"
                                                         alt="Rápido y sin espera">
                                                </a>
                                                <h3>Informática</h3>
                                            </li>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/analisis.png') }}">
                                                </a>
                                                <h3>Análisis</h3>
                                            </li>
                                        </ul>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/seguridad.png') }}">
                                                </a>
                                                <h3>Seguridad</h3>
                                            </li>
                                        </ul>
        ...
        <div class="section section-tabs"
             style="background-image: url({{ asset('img/bg9.jpg') }}); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <!-- Tabs with icons on Card -->
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/inmersion.png') }}">
                                                </a>
                                                <h3>Inmersión</h3>
                                            </li>
                                        </ul>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs">
                                            <li class="active center-block">
                                                <a href="#profile2" data-toggle="tab">
                                                    <img src="{{ asset('img/atencion.png') }}">
                                                </a>
                                                <h3>Más atención</h3>
                                            </li>
                                        </ul>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/mas_rapido.png') }}">
                                                </a>
                                                <h3>Más Rápido</h3>
                                            </li>
                                        </ul>
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs" data-tabs="tabs">
                                            <li class="active">
                                                <a href="#" data-toggle="tab">
                                                    <img src="{{ asset('img/mas_efectivo.png') }}">
                                                </a>
                                                <h3>Más efectivo</h3>
                                            </li>
                                        </ul>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h4 class="text-center description">
                        ...
                        @endif
                        {!! Form::open(['url' => '/contacts', 'class' => 'contact-form', 'files' => true]) !!}
            ...
            <div class="main main-raised">
                <div class="row">
                    <div class="col-md-3 center-block">
                        <img src="{{ asset('img/MinTIC.png') }}" class="img-responsive center-block">
                    </div>
                    <div class="col-md-2 center-block">
                        <img src="{{ asset('img/vivedigital.png') }}" class="img-responsive center-block">
                    </div>
                    <div class="col-md-2 center-block">
                        <br>
                        <img src="{{ asset('img/appco.png') }}" class="img-responsive center-block">
                    </div>
                    <div class="col-md-3 center-block">
                        <img src="{{ asset('img/colciencias.png') }}" class="img-responsive center-block">
                    </div>
                    <div class="col-md-2 center-block">
                        <img src="{{ asset('img/unnuevopais.png') }}" class="img-responsive center-block">
                    </div>
