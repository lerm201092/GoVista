...
@section('content_body')
    <div class="container-fluid">  
                <div class="card">	
                    ...
                    <br>
					<b style="color: black !important;">Paciente:&nbsp;</b> {!! $appointments[0]->name1.' '.$appointments[0]->name2.' '.$appointments[0]->surname1.' '.$appointments[0]->surname2 !!} 
					<b style="padding-left: 20px;color: black !important;">Edad:&nbsp;</b> {!! $edadPaciente .' Años ' !!}
					<b style="padding-left: 20px;color: black !important;">Fecha Cita:&nbsp;</b> {!! $appointments[0]->historydate !!}
					<b title="Ejercicios Activos" style="padding-left: 20px;color: black !important;"><i style="font-size: 14px !important;" class="material-icons">fitness_center</i>&nbsp;Activos:&nbsp;</b>{{ (isset( $qty_exe['AC'])) ? $qty_exe['AC'] : 0}}
					<b title="Ejercicios Realizados" style="padding-left: 20px;color: black !important;"><i style="font-size: 14px !important;" class="material-icons">fitness_center</i>&nbsp;Realizados:&nbsp;</b>{{ (isset( $qty_exe['OK'])) ? $qty_exe['OK'] : 0 }}
                    </span>
					</div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12"> 
                                    ...
                                    {!! Form::open(['url' => '/modulos/histories', 'id' => 'formMain', 'class' => 'form', 'files' => true ]) !!}
...
@section('scripts')
    <script type="text/javascript">
        ...
        function findExercise(obj) {
            ...
            var Exercise_text = "";
            var Exercise_Observ = "";
            $.get("{!!URL::to('/findExerciseId')!!}", { id: cmbExercise_id },function(data){
                if(data.length>0){
