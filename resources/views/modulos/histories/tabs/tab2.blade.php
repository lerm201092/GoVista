        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group label-floating">
                    ...
                    {!! Form::textarea('motivo', isset($historyFill) ? $historyFill->motivo : null,  ['class' => 'form-control', 'maxlength' => '500']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group label-floating">
                    ...
                    {!! Form::textarea('enfactual', isset($historyFill) ? $historyFill->enfactual : null,  ['class' => 'form-control', 'maxlength' => '500']) !!}
