<div class="tab-pane fade" id="tab_6"> <!-- begin: Tab_6 -->
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group label-floating">
                    {!! Form::text('complicacion', isset($historyFill) ? $historyFill->complicacion : null,  ['class' => 'form-control']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group label-floating">
                    {!! Form::text('finalidad', isset($historyFill) ? $historyFill->finalidad : null,  ['class' => 'form-control']) !!}
