                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            {!! Form::text('tipolente', isset($historyFill) ? $historyFill->tipolente : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            {!! Form::text('color', isset($historyFill) ? $historyFill->color : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            {!! Form::text('filtro', isset($historyFill) ? $historyFill->filtro : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            ...
                            {!! Form::text('usolente', isset($historyFill) ? $historyFill->usolente : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="panel panel-default"> <!-- begin: Panel Agudeza Visual (Tab_3) -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('od_prisma', isset($historyFill) ? $historyFill->od_prisma : null,  ['class' => 'form-control','disabled']) !!}
                            {!! $errors->first('od_prisma', '<p class="help-block">:message</p>') !!}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('od_base', isset($historyFill) ? $historyFill->od_base : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('oi_prisma', isset($historyFill) ? $historyFill->oi_prisma : null,  ['class' => 'form-control','disabled']) !!}
                            {!! $errors->first('oi_prisma', '<p class="help-block">:message</p>') !!}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('oi_base', isset($historyFill) ? $historyFill->oi_base : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                        {!! Form::text('ppc_or', isset($historyFill) ? $historyFill->ppc_or : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            {!! Form::text('ppc_sf', isset($historyFill) ? $historyFill->ppc_sf : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('od_fijacion', isset($historyFill) ? $historyFill->od_fijacion : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            {!! Form::text('ctest_lejos', isset($historyFill) ? $historyFill->ctest_lejos : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('oi_fijacion', isset($historyFill) ? $historyFill->oi_fijacion : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group label-floating">
                            {!! Form::text('ctest_cerca', isset($historyFill) ? $historyFill->ctest_cerca : null,  ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('dist_interpupilar', isset($historyFill) ? $historyFill->dist_interpupilar : null,  ['class' => 'form-control','disabled']) !!}
                    ...
                    <div class="col-md-2">
                        <div class="form-group label-floating">
                            {!! Form::text('pupila', isset($historyFill) ? $historyFill->pupila : null, ['class' => 'form-control','disabled']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group label-floating">
                            {!! Form::textarea('observacion', isset($historyFill) ? $historyFill->observacion : null, ['class'=>'form-control','disabled', 'rows' => 2, 'cols' => 50, 'maxlength' => '500']) !!}
                        </div>
                    </div>
                </div>
