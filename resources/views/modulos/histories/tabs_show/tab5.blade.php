<div class="tab-pane fade" id="tab_5">  <!-- begin: Tab_5 -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('rfnv_vl', isset($historyFill) ? $historyFill->rfnv_vl : null,  ['class' => 'form-control','disabled']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('rfn_vp', isset($historyFill) ? $historyFill->rfn_vp : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('rfp_vl', isset($historyFill) ? $historyFill->rfp_vl : null,  ['class' => 'form-control','disabled']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('rfp_vp', isset($historyFill) ? $historyFill->rfp_vp : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('aa_od', isset($historyFill) ? $historyFill->aa_od : null,  ['class' => 'form-control','disabled']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('aa_oi', isset($historyFill) ? $historyFill->aa_oi : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('nivel_visual_od', isset($historyFill) ? $historyFill->nivel_visual_od : null,  ['class' => 'form-control','disabled']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('nivel_visual_oi', isset($historyFill) ? $historyFill->nivel_visual_oi : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group label-floating">
                    {!! Form::text('tecnica', isset($historyFill) ? $historyFill->tecnica : null,  ['class' => 'form-control','disabled']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('flexibilidad_od', isset($historyFill) ? $historyFill->flexibilidad_od : null,  ['class' => 'form-control','disabled']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group label-floating">
                    {!! Form::text('flexibilidad_oi', isset($historyFill) ? $historyFill->flexibilidad_oi : null,  ['class' => 'form-control','disabled']) !!}
