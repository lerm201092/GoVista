                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel-body">                                    
                                    ...
                                    @endif
                                    {!! Form::open(['url' => '/modulos/patients', 'class' => 'form', 'files' => true]) !!}
                                        @include ('modulos.patients.form',['fecha_actual' => date('Y-m-d') ])
            ...
            $('#dpto_cmb').change(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        op += '</select>'
                        op += "{!! $errors->first('id_area', '<p class="help-block">:message</p>') !!}";
                        $("#div_municipio").empty();
