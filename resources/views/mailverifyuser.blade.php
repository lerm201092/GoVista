...
<a style="border:none !important;border-radius:4px;display:inline-block;font-size:14px;font-weight:bold;line-height:24px;padding:10px;text-align:center;text-decoration:none!important;color:#fff!important;background-color:#3097d1;font-weight:bold !important;" target="_blank" href="{!!URL::to('/activation/user/')!!}/{{ $tokenReset }}">Activar Mi Cuenta</a>  
<p>Si tiene problemas para hacer clic en el botón "Activar Mi Cuenta", copie y pegue la siguiente URL en su navegador web.</p>
<p>{!!URL::to('/activation/user/')!!}/{{ $tokenReset }}</p>
<br />
