...
Ball.Game.prototype = {
	create: function() {
		...
		this.fontSmall = { font: "12px Arial", fill: "#e4beef" };
		this.fontBig = { font: "20px Arial", fill: "#e4beef" };
		this.fontMessage = { font: "20px Arial", fill: "#e4beef",  align: "center", stroke: "#320C3E", strokeThickness: 4 };
		...
		this.levelText = this.game.add.text(120, 10, "Nivel: "+this.level+" / "+this.maxLevels, this.fontSmall);
		this.totalTimeText = this.game.add.text(120, 30, "Total tiempo: "+this.totalTimer, this.fontSmall);
	...
	updateCounter: function() {
		...
		this.totalTimeText.setText("Total Tiempo: "+(this.totalTimer+this.timer));
	},
